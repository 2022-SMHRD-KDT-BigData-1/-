				...
				<div class="col">
					<div class="card h-100 border-dark "
						...
						<ul class="ed" style="font-size: larger; padding-left: 5%;">
							<br>
							<li><b>스케줄명 : </b> <span>자바</span></li>
							<li><b>작성일 : </b> <span>2022.01.11</span></li>
						</ul>
						<br>
						<div class="text-center">
							<p>엽떡은 맨날 먹어도 맛있다,,내일 또 먹어야지~!</p>
							<p>이렇게 내 통장은 텅장이 되어가고 희희
							<p>어휴 할게 너무 많네 끝이없다,,ㅠ</p>
							</p>
							<p>
								<자격증 일정> - 정보처리기사 필기 시험 : 3월 5일 
							</p>
						</div>
